...
INSERT INTO "new_tenpo_purchases" ("amount_total_clp", "created_at", "email_id", "first_due_date_override", "id", "installments_count", "interes_total_estimado", "merchant", "metadata", "modo_monto", "purchase_date", "schedule_mode", "tiene_interes", "total_financiado_estimado", "updated_at") SELECT "amount_total_clp", "created_at", "email_id", "first_due_date_override", "id", "installments_count", "interes_total_estimado", "merchant", "metadata", "modo_monto", "purchase_date", "schedule_mode", "tiene_interes", "total_financiado_estimado", "updated_at" FROM "tenpo_purchases";
